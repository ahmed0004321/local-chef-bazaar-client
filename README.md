...
## 🌐 Live Links
- **Frontend**: [https://local-chef-bazaar-client.vercel.app/](https://local-chef-bazaar-client.vercel.app/)
- **Backend API**: [https://local-chef-bazaar-server-one.vercel.app](https://local-chef-bazaar-server-one.vercel.app)
